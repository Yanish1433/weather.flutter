import 'package:flutter/material.dart';
  ...
  class _WeatherScreenState extends State<WeatherScreen> {
    final String baseUrl = 'https://us-central1-weather-3bd18.cloudfunctions.net/getWeather';
    final String forecastUrl = 'https://us-central1-weather-3bd18.cloudfunctions.net/getForecast';
    String? city;
    String? temperature;
    String? description;
    String? rainChance;
    ...
    Future<void> fetchWeather(String query) async {
      ...
      try {
        final weatherUrl = Uri.parse('$baseUrl?city=$query');
        print('Fetching weather for URL: $weatherUrl');
        ...
        if (weatherResponse.statusCode == 200) {
          ...
          final forecastUrlFinal = Uri.parse('$forecastUrl?city=$query');
          print('Fetching forecast for URL: $forecastUrlFinal');
          final forecastResponse = await http.get(forecastUrlFinal);
          print('Forecast API Response Status: ${forecastResponse.statusCode}');
          print('Forecast API Response Body: ${forecastResponse.body}');
                              ...
                              : ListView(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        _buildWeatherCard('Rain', rainChance ?? 'N/A', Icons.water_drop),
                                        _buildWeatherCard('Humidity', humidity ?? 'N/A', Icons.opacity),
                                        _buildWeatherCard('Wind', windSpeed ?? 'N/A', Icons.air),
                                      ],
                                    ),
                                  ],
                                ),
